...
<body>
    ...
    <div class="container">
        <div id="smartwizard" dir="" class="sw sw-theme-arrows sw-justified">
                        ...
                        <div class="col">
                            ...
                            <div class="row gy-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="cc-name" value="My Name" placeholder=""
                                        required="">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="cc-cvv" value="123" placeholder=""
                                        required="">
                                    <div class="invalid-feedback">
                                ...
                                <small class="text-muted">This is an example page, do not enter any real data, even tho
            ...
            <div class="sw-toolbar-elm toolbar toolbar-bottom" role="toolbar"><button
                    class="btn sw-btn-prev sw-btn disabled" type="button">Previous</button><button
                    class="btn sw-btn-next sw-btn" type="button">Next</button><button class="btn btn-success"
                    id="btnFinish" disabled="" onclick="onConfirm()">Complete Order</button>
